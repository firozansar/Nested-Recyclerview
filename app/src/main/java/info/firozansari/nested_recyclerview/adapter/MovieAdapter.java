...
import info.firozansari.nested_recyclerview.helper.Helper;
...
import info.firozansari.nested_recyclerview.model.RelatedMoviesItem;
...
//        holder.date.setText(movie.getReleaseDate());
    ...
    class RelatedMoviesViewHolder extends GenericViewHolder {
        ...
        @BindView(R.id.related_movies_recycler)
        protected RecyclerView relatedItemsRecyclerView;

        @BindView(R.id.related_movies_header)
